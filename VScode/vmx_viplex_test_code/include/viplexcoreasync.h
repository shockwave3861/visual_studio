...
{
public:
    static void setDevLang(const char *devLang);
    ...
    static void nvEeadFileContentFromZipFileAsync(const char *data, ViplexCallback callback);
    ...
    static void nvSetAudioProgramAsync(const char *data,ViplexCallback callback);
