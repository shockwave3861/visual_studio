...
#pragma endregion 其他  待补充
    ...
    VIPLEX_EXPORT void nvDownloadTerminalAllLogAsyncW(const char *data, ExportViplexCallback callback);

    VIPLEX_EXPORT void nvDownloadTerminalPlayLogAsyncW(const char *data, ExportViplexCallback callback);
}
