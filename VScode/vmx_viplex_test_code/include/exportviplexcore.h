...
#pragma region RadioFrequency
   ...
   * @return void
   */
   void getLoraInfo(const char *data, ViplexCallback callBack);
...
#pragma region PowerController
    ...
    * @number 99
    */
   VIPLEX_EXPORT void setPowerInfoManual(const char *data, ViplexCallback callBack);
   /**
    * showdoc
    * @catalog 接口示例/终端电源控制/终端电源控制
    * @title 设置手动多功能卡电源控制任务
    ...
    * @number 99
    */
   VIPLEX_EXPORT void setPowerInfoPolicy(const char *data, ViplexCallback callBack);
   /**
    * showdoc
    * @catalog 接口示例/终端电源控制/终端电源控制
    * @title 获取定时多功能电源控制任务
    ...
    * @number 99
    */
   VIPLEX_EXPORT void getPowerInfoPolicy(const char *data, ViplexCallback callBack);
   /**
    * showdoc
    * @catalog 接口示例/终端电源控制/终端电源控制
    * @title 获取多功能卡电源状态
    ...
    * @number 99
    */
   VIPLEX_EXPORT void getPowerInfoStatus(const char *data, ViplexCallback callBack);
   /**
    * showdoc
    ...
    * @number 99
    */
   VIPLEX_EXPORT void setPowerMode(const char *data, ViplexCallback callBack);
   /**
    * showdoc
    * @catalog 接口示例/终端电源控制/终端电源控制模式
    * @title 获取终端电源模式
    ...
    * @number 99
    */
   VIPLEX_EXPORT void getPowerMode(const char *data, ViplexCallback callBack);
   /**
    * showdoc
    * @catalog 接口示例/终端电源控制/终端电源控制
    * @title 设置本板电源手动控制任务
 ...
 * @returnVIPLEX_EXPORT void
 */
   VIPLEX_EXPORT void setManualBrightnessFor0x99(const string &data, ViplexCallback callback);
   /**
 * @brief 设置亮度调节方案
 * @param const char * data
 {
 ...
 * @returnVIPLEX_EXPORT void
 */
   VIPLEX_EXPORT void setPolicyBrightnessFor0x99(const string &data, ViplexCallback callback);
...
#pragma region AdvancedFeatures
  ...
  */
	...
	* @return void
	*/
   VIPLEX_EXPORT void getHdmiOutputStatus(const char *data, ViplexCallback callBack);
   ...
   * @return void
   */
   VIPLEX_EXPORT void setHdmiOutputStatus(const char *data, ViplexCallback callBack);
   ...
   * @return void
   */
   VIPLEX_EXPORT void setCustomResolution(const char *data, ViplexCallback callBack);
...
*/
   ...
   * @return void
   */
   VIPLEX_EXPORT void getAPNetworkOpenStatus(const char *data, ViplexCallback callBack);
   ...
   * @return void
   */
   VIPLEX_EXPORT void setAPNetworkOpenStatus(const char * data, ViplexCallback callBack);
   ...
   */
    ...
    * @number 99
    */
   VIPLEX_EXPORT void setFlightMode(const char *data, ViplexCallback callback);
    ...
    * @number 99
    */
   VIPLEX_EXPORT void getFlightMode(const char *data, ViplexCallback callback);
    ...
    * @number 99
    */
   VIPLEX_EXPORT void get4GNetworkStatus(const char *data, ViplexCallback callback);
...
#pragma region MonitorConfigurator
   ...
   */
	...
	* @return void
	*/
   VIPLEX_EXPORT void addCollector(const char *data, ViplexCallback callBack);
	...
	* @return void
	*/
   VIPLEX_EXPORT void deleteCollector(const char *data, ViplexCallback callBack);
   ...
   /**
	 ...
	 * @return void
	 */
   VIPLEX_EXPORT void getSendCardMonitorInfo(const char *data, ViplexCallback callBack);
   ...
   /**
	 ...
	 * @return void
	 */
   VIPLEX_EXPORT void getReceiverCountAndInfo(const char *data, ViplexCallback callBack);
   ...
   /**
	 ...
	 * @return void
	 */
   VIPLEX_EXPORT void getMonitorInfoByReceiverIndex(const char *data, ViplexCallback callBack);
...
#pragma region Remotemanager
   ...
   VIPLEX_EXPORT void addNodeServerInfoList(const char *data, ExportViplexCallback callBack);
	void isCommonCloud(const char *data, ExportViplexCallback callBack);
	void getPlayerIdentifer(const char *data, ExportViplexCallback callBack);
	void isExistPlayerName(const char *data, ExportViplexCallback callBack);
	void newSetBindPlayer(const char *data, ExportViplexCallback callBack);
	void getToken(const char *data, ExportViplexCallback callBack);
